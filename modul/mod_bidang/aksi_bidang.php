...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  if ($module=='bidang' AND $act=='hapus'){
    $hapus = "DELETE FROM bidang WHERE id='$_GET[id]'";
  ...
  if ($module=='bidang' AND $act=='input'){
    ...
    $input = "INSERT INTO bidang(nama_bidang) VALUES('$nama_bidang')";
  ...
  elseif ($module=='bidang' AND $act=='update'){
    ...
    $update = "UPDATE bidang SET nama_bidang='$nama_bidang' WHERE id='$id'";
