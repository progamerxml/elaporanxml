...
?>
		...
		<ol class="breadcrumb">
            <li><a class="btn btn-warning btn-sm" href="<?php echo $base_url.$mod; ?>-tambah.html"><i class="fa fa-plus"></i>Tambah Bidang</a></li>
        </ol>
	</section>
	<hr>
                <div class="box-body">
...
FROM `bidang`  order by id DESC";
					...
					while ($r=mysqli_fetch_array($tampil)){  
						echo "<tr><td>$no</td>
                			...
                			<a href=\"$aksi?module=bidang&act=hapus&id=$r[id]\" onclick=\"return confirm('APAKAH ANDA YAKIN AKAN MENGHAPUS DATA INI ?')\" title=\"Hapus Data\"><i class=\"fa fa-trash text-red\"></i></a> &nbsp; 
	                    	</td>
							</tr>";
						$no++;
					}
...
?>
			<div class="box">
                ...
                <form method="POST" action="<?php echo $aksi; ?>?module=bidang&act=input" class="form-horizontal">
					<div class="box-body">
						<div class="form-group">
			
						<div class="form-group">
							<label for="pembuat" class="col-sm-2 control-label">Nama Bidang</label>
							<div class="col-sm-6">
...
?>
			<div class="box">
                ...
                <form method="POST" action="<?php echo $aksi; ?>?module=bidang&act=update" class="form-horizontal">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="pembuat" class="col-sm-2 control-label">Nama Bidang</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="nama_bidang" name="nama_bidang" value="<?php echo $res['nama_bidang'];?>"/>
							</div>
						</div>
					</div><!-- /.box-body -->
					<div class="box-footer">
