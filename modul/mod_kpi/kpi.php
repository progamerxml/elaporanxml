                ...
                <div class="modal-content">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recap" name="recap" placeholder="Recap" required>
                            <br>
                            <label for="target">
                                Target
                            </label>
                            <input type="number" class="form-control" id="target" name="target" placeholder="Target" required>
                            <br>
