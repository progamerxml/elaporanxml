...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Tukang Tidur',0,'L');
$pdf->SetX(4);
...
$pdf->Cell(25.5,0.7,"Laporan Kinerja Harian",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(7, 0.8, 'Satuan', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Target', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Suplier', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, 'Id Pegawai', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, 'Harga', 1, 0, 'C');
$pdf->Cell(2, 0.8, 'Score', 1, 1, 'C');
$pdf->SetFont('Arial','',10);
$no=1;
$query=mysql_query("select * from kegiatan");
while($lihat=mysql_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(7, 0.8, $lihat['uraian'],1, 0, 'C');
	$pdf->Cell(3, 0.8, $lihat['satuan'], 1, 0,'C');
	$pdf->Cell(4, 0.8, $lihat['target'],1, 0, 'C');
	$pdf->Cell(4.5, 0.8, $lihat['id_pegawai'], 1, 0,'C');
	$pdf->Cell(4.5, 0.8, $lihat['harga'],1, 0, 'C');
	$pdf->Cell(2, 0.8, $lihat['Score'], 1, 1,'C');
